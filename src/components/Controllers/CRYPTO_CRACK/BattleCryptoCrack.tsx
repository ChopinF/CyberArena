...
import TerminalCryptoCrack from "./TerminalCryptoCrack";
...
export default function BattleCryptoCrack() {
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-900 p-8">
      <div className="flex gap-8 w-full max-w-[90%]">
        ...
        <div className="flex-1 p-6 bg-gray-800 rounded-xl shadow-xl h-[80vh]">
          ...
          <TerminalCryptoCrack side="offensive" terminalLineData={lines} action={setLines} />
        </div>
        {/* Terminal Defensive */}
        <div className="flex-1 p-6 bg-gray-800 rounded-xl shadow-xl h-[80vh]">
          ...
          <TerminalCryptoCrack side="defensive" terminalLineData={lines} action={setLines} />
        </div>
      </div>
